...
## Scope and non-goals
Version 3 is a compact identity-first academic redesign informed by actual researcher websites: real portrait, PhD identity, research summary and contact actions within the first viewport; light purple palette, Newsreader English headings and Noto Sans SC Chinese typography, scientific figures, publications beside an academic side rail, and modest purposeful motion. Versions 1, 2 and 3 are retained as tags v1.0.0/v2.0.0/v3.0.0 and branches archive/v1.0/archive/v2.0/archive/v3.0. V3.1 refines this composition with a large GitHub Profile feature and actual contribution screenshots, improved Chinese typography and drawn SC initials. No invented reference portraits/papers/dates. No unrelated visual gimmicks, irrelevant badges, empty controls or fake metrics. No paid service. Original documents untouched. V3.2 explicitly authorizes the profile repo CAOShurong/CAOShurong (homepage banner and account website field) and the separate academic-website-mirror Sites checkout for a free public alternate URL. Other repositories remain outside scope.
## Project map
...
## Latest refinement scope
V3.3 preserves the accepted V3.2 homepage while linking identity, affiliation, research terms, paper titles, education and exchange content. The owner's second-level feedback means research/publications/project destination pages. Their structure and purple/white balance remain a separate design exploration in DESIGN_NOTES.md. V3.2 remains available at v3.2.0/archive/v3.2, source 3ea4904.
## Commands and verification
Build: Python build.py. Preview: python -m http.server 8765 --bind 127.0.0.1 --directory site. Deploy site/ via GitHub Actions Pages. Use real browser checks desktop/mobile, language, links, details, CV, reload and published site. Privacy scan all public source and PDFs. After public Chinese text changes: build, run scripts/refresh_chinese_font.py, rebuild and inspect.
## Constraints
Payloads on E:. Public contact only shurongcao0819@gmail.com. Institutional email displayed literally **********@link.cuhk.edu.hk; full local part must never be in source, links, metadata, PDF or git history. Contact note requests Gmail first for subsequent communication through the university email. No phone. New public CV replaces old inaccurate/private version. Source truth is latest user corrections over old CV.
## Data and provenance
CUHK EE PhD year one, Prof. Ni Zhao, exploring BEOL/M3D/low-temperature/p-type oxide/complementary devices, not a fixed dissertation nor demonstrated ALD/CVD proficiency. NJU B.Eng. Integrated Circuit and System Design 2022–2026. FALCO-WAFER co-first author, IEEE ITC-Asia2025 pp43–47, DOI 10.1109/ITC-Asia67627.2025.00016; 90.7% AP@0.5,7.19% FNR,13.3M parameters,5723 images. Texture-AD arXiv2409.06367 fourth author; CVM2026 is same work. Latest presentation choice: keep publication author order and original stars, but omit explicit author-position labels and equal-contribution notes. Local September2026 CV and January2026 PPT contain useful detail but some stale authorship and metrics. Guo Xie Birong Scholarship (郭谢碧蓉奖学金), Nanjing University, RMB 10,000 confirmed by owner; no personal award year inferred. Prioritize over People’s Scholarship. Avoid uncertain GPA/rank. One granted vacuum-gauge patent is verified in D-20260911-030000-patent.
