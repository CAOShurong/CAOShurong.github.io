...
## Deliverables
English default, full Chinese equivalent, corresponding route switching and remembered language. Home, research, publications, project details, education/experience, public CV and contact. Actual paper figures and selected project visuals. Latest user supplied gray-jacket portrait; official NJU/CUHK crests and HKUST (Guangzhou)/Cambridge exchange logos, without exchange dates; no generic vertical-integration hero. Wide image-led research and publication cards, education and exchange section and explicit dropdown navigation. NJU undergraduate to CUHK PhD progression. Maintainer and upstream contributor identity. Public-safe downloadable CV. Real local and live browser acceptance. Portable project handoff.
## Scope and non-goals
Warm white/plum/lilac, serif headings, readable body, fine rules, restrained visuals based on four reference mockups. No invented reference portraits/papers/dates. No flashy gradients, irrelevant badges, empty controls or fake metrics. No paid service. Original documents untouched. Do not modify other repos.
## Project map
