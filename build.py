...
<div class="identity-heading"><p class="eyebrow">{tx("Electronic Engineering · CUHK","电子工程 · 香港中文大学",l)}</p><h1 id="identity-title">{tx("Shurong Cao","曹书嵘",l)}<span>{tx("曹书嵘","Shurong Cao",l)}</span></h1><p class="identity-role">{tx("PhD student · Semiconductor devices & integration","博士研究生 · 半导体器件与集成",l)}</p></div>
<div class="identity-portrait">{portrait(l)}<span>{tx("Hong Kong","香港",l)} · 2026</span></div>
<div class="identity-bio"><p>{tx("I am a PhD student in Electronic Engineering at <strong>The Chinese University of Hong Kong</strong>, advised by <strong>Prof. Ni Zhao</strong>.","我是<strong>香港中文大学</strong>电子工程博士研究生，导师为 <strong>Prof. Ni Zhao</strong>。目前探索半导体器件与低温工艺，关注如何在现有硅基电路之上实现新的功能。",l)}</p><p>{tx("I explore <strong>BEOL-compatible devices</strong>, <strong>p-type oxides</strong> and <strong>monolithic 3D integration</strong>, with an interest in low-temperature fabrication. My background at Nanjing University spans integrated circuits, device simulation, industrial vision and intelligent hardware.","当前兴趣连接 <strong>BEOL 兼容器件</strong>、<strong>p 型氧化物</strong>与<strong>单片三维集成</strong>。本科就读于南京大学集成电路学院，此前的研究与实践涵盖器件仿真、工业视觉与智能硬件。",l)}</p><div class="identity-links">{link("https://github.com/CAOShurong","GitHub Profile <span>↗</span>","button")}{link(url("cv",l),tx("CV","个人简历",l)+" ↗")}{link("mailto:"+EMAIL,tx("Email me","邮件联系",l)+" ↗")}</div><a class="identity-email" href="mailto:{EMAIL}">{EMAIL}</a></div></section>
